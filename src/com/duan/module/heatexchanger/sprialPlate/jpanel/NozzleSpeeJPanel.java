...
public class NozzleSpeeJPanel extends JPanel {
	...
	public NozzleSpeeJPanel(SprialPlateHeatExchanger sprialHeat) {
		...
		hotInletIDField.getDocument().addDocumentListener(new HotInletDocListener());

		coldInletIDField = new PureNumField();
		coldInletIDField.setBounds(209, 39, 66, 20);
		panel.add(coldInletIDField);

		coldInletIDField.getDocument().addDocumentListener(new ColdInletDocListener());
		...
		coldOutletIDField.getDocument().addDocumentListener(new ColdOutletDocListener());

		hotOutletIDField = new PureNumField();
		hotOutletIDField.setBounds(133, 71, 66, 20);
		panel.add(hotOutletIDField);

		hotOutletIDField.getDocument().addDocumentListener(new HotOutletDocListener());
	...
	class HotInletDocListener implements DocumentListener,Serializable{

		private static final long serialVersionUID = 5309030523508123281L;
		@Override
	...
	class HotOutletDocListener implements DocumentListener,Serializable{
		private static final long serialVersionUID = -3269204551648435219L;
		@Override
		public void removeUpdate(DocumentEvent e) {
			// TODO Auto-generated method stub
			double volumeFlow = sprialHeat.getSpheDesignConditions().getHotDesignCondition().getVolumnFlow();
	...
	class ColdInletDocListener implements DocumentListener,Serializable{
		private static final long serialVersionUID = -6431399911370448675L;
	...
	class ColdOutletDocListener implements DocumentListener,Serializable{
	
		private static final long serialVersionUID = -450534635405069205L;
